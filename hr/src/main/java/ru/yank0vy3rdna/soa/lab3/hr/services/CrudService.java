...
public class CrudService {
    ...
    public Worker update(Long workerId, WorkerInput input) {
        ...
        try {
            ...
            return this.restTemplate.patchForObject("http://mule:8081/workers?workerId={workerId}", request, Worker.class, urlParams);
    ...
    public Worker getById(Long workerId) {
        Map<String, Long> urlParams = new HashMap<>();
        urlParams.put("workerId", workerId);
        return this.restTemplate.getForObject("http://mule:8081/workers/{workerId}", Worker.class, urlParams);
    }
}
